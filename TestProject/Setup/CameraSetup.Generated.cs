...
namespace TestProject
{
    ...
    internal static class CameraSetup
    {
        ...
        public static void ResetGumResolutionValues () 
        {
            ...
            {
                global::RenderingLibrary.SystemManagers.Default.Renderer.Camera.Zoom = Data.ScaleGum/100.0f * Data.Scale/100.0f;
                Gum.Wireframe.GraphicalUiElement.CanvasWidth = FlatRedBall.Camera.Main.DestinationRectangle.Width / (Data.ScaleGum/100.0f * Data.Scale / 100.0f);
                Gum.Wireframe.GraphicalUiElement.CanvasHeight = FlatRedBall.Camera.Main.DestinationRectangle.Height / (Data.ScaleGum/100.0f * Data.Scale / 100.0f); 
            }
            else
            {
            ...
            var gumScreenOwner = FlatRedBall.Screens.ScreenManager.CurrentScreen as FlatRedBall.Gum.IGumScreenOwner;
            gumScreenOwner?.RefreshLayout();
        }
