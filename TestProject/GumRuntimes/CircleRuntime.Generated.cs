...
{
    public partial class CircleRuntime : global::Gum.Wireframe.GraphicalUiElement
    {
        public CircleRuntime () 
        	: this(true, true)
        {
        }
        public CircleRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
        {
            ...
            {
                Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.StandardElements.First(item => item.Name == "Circle");
        ...
        RenderingLibrary.Math.Geometry.LineCircle mContainedCircle;
        RenderingLibrary.Math.Geometry.LineCircle ContainedCircle
        {
            get
            {
                if (mContainedCircle == null)
                {
                    mContainedCircle = this.RenderableComponent as RenderingLibrary.Math.Geometry.LineCircle;
                }
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            bool setRadiusFirstValue = false;
            bool setRadiusSecondValue = false;
            float RadiusFirstValue= 0;
            float RadiusSecondValue= 0;
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    setRadiusFirstValue = true;
                    RadiusFirstValue = 16f;
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    setRadiusSecondValue = true;
                    RadiusSecondValue = 16f;
            ...
            if (setRadiusFirstValue && setRadiusSecondValue)
            {
                Radius = RadiusFirstValue * (1 - interpolationValue) + RadiusSecondValue * interpolationValue;
            }
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.CircleRuntime.VariableState fromState,global::TestProject.GumRuntimes.CircleRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public int Alpha
        {
            get
            {
                return ContainedCircle.Color.A;
            }
            set
            {
                ...
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithAlpha(ContainedCircle.Color, (byte)value);
        ...
        public int Blue
        {
            get
            {
                return ContainedCircle.Color.B;
            }
            set
            {
                // The new version of Glue is moving away from XNA color values. This code converts color values. If this doesn't run, you need to upgrade your GLUX version.
                // More info here: https://flatredball.com/documentation/tools/glue-reference/glujglux/
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithBlue(ContainedCircle.Color, (byte)value);
                ContainedCircle.Color = color;
            }
        }
        public int Green
        {
            get
            {
                return ContainedCircle.Color.G;
            }
            set
            {
                // The new version of Glue is moving away from XNA color values. This code converts color values. If this doesn't run, you need to upgrade your GLUX version.
                // More info here: https://flatredball.com/documentation/tools/glue-reference/glujglux/
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithGreen(ContainedCircle.Color, (byte)value);
                ContainedCircle.Color = color;
            }
        }
        public float Radius
        ...
        public int Red
        {
            get
            {
                return ContainedCircle.Color.R;
            }
            set
            {
                // The new version of Glue is moving away from XNA color values. This code converts color values. If this doesn't run, you need to upgrade your GLUX version.
                // More info here: https://flatredball.com/documentation/tools/glue-reference/glujglux/
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithRed(ContainedCircle.Color, (byte)value);
                ContainedCircle.Color = color;
            }
        }
        public Microsoft.Xna.Framework.Color Color
        {
            get
            {
                return RenderingLibrary.Graphics.XNAExtensions.ToXNA(ContainedCircle.Color);
            }
            set
            {
                ContainedCircle.Color = RenderingLibrary.Graphics.XNAExtensions.ToSystemDrawing(value);
