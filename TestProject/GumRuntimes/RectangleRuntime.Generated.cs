...
{
    public partial class RectangleRuntime : global::Gum.Wireframe.GraphicalUiElement
    {
        public RectangleRuntime () 
        	: this(true, true)
        {
        }
        public RectangleRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
        {
            ...
            {
                Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.StandardElements.First(item => item.Name == "Rectangle");
        ...
        RenderingLibrary.Math.Geometry.LineRectangle mContainedRectangle;
        RenderingLibrary.Math.Geometry.LineRectangle ContainedRectangle
        {
            get
            {
                if (mContainedRectangle == null)
                {
                    mContainedRectangle = this.RenderableComponent as RenderingLibrary.Math.Geometry.LineRectangle;
                }
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.RectangleRuntime.VariableState fromState,global::TestProject.GumRuntimes.RectangleRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public int Alpha
        {
            get
            {
                return ContainedRectangle.Color.A;
            }
            set
            {
                ...
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithAlpha(ContainedRectangle.Color, (byte)value);
                ContainedRectangle.Color = color;
            }
        }
        public int Blue
        {
            get
            {
                return ContainedRectangle.Color.B;
            }
            set
            {
                // The new version of Glue is moving away from XNA color values. This code converts color values. If this doesn't run, you need to upgrade your GLUX version.
                // More info here: https://flatredball.com/documentation/tools/glue-reference/glujglux/
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithBlue(ContainedRectangle.Color, (byte)value);
                ContainedRectangle.Color = color;
            }
        }
        public int Green
        {
            get
            {
                return ContainedRectangle.Color.G;
            }
            set
            {
                // The new version of Glue is moving away from XNA color values. This code converts color values. If this doesn't run, you need to upgrade your GLUX version.
                // More info here: https://flatredball.com/documentation/tools/glue-reference/glujglux/
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithGreen(ContainedRectangle.Color, (byte)value);
                ContainedRectangle.Color = color;
            }
        }
        public int Red
        {
            get
            {
                return ContainedRectangle.Color.R;
            }
            set
            {
                // The new version of Glue is moving away from XNA color values. This code converts color values. If this doesn't run, you need to upgrade your GLUX version.
                // More info here: https://flatredball.com/documentation/tools/glue-reference/glujglux/
                var color = ToolsUtilitiesStandard.Helpers.ColorExtensions.WithRed(ContainedRectangle.Color, (byte)value);
                ContainedRectangle.Color = color;
            }
        }
        public Microsoft.Xna.Framework.Color Color
        {
            get
            {
                return RenderingLibrary.Graphics.XNAExtensions.ToXNA(ContainedRectangle.Color);
            }
            set
            {
                ContainedRectangle.Color = RenderingLibrary.Graphics.XNAExtensions.ToSystemDrawing(value);
