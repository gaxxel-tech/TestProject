...
{
    public partial class DividerHorizontalRuntime : global::TestProject.GumRuntimes.ContainerRuntime
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        AccentLeft.CurrentColorCategoryState = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                        ...
                        Line.TextureWidth = 3;
                        Line.Width = -8f;
                        Line.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory AccentLeftCurrentColorCategoryStateFirstValue= global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Black;
            global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory AccentLeftCurrentColorCategoryStateSecondValue= global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Black;
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    AccentLeftCurrentColorCategoryStateFirstValue = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
                    ...
                    LineWidthFirstValue = -8f;
                    if (interpolationValue < 1)
                    {
                        this.Line.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    AccentLeftCurrentColorCategoryStateSecondValue = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Gray;
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Elements.DividerHorizontalRuntime.VariableState fromState,global::TestProject.GumRuntimes.Elements.DividerHorizontalRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state) 
        {
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    {
                        SetsValue = true,
                        Name = "AccentLeft.TextureAddress",
                        Type = "TextureAddress",
        ...
        public global::TestProject.GumRuntimes.SpriteRuntime AccentLeft { get; set; }
        ...
        public DividerHorizontalRuntime () 
        	: this(true, true)
        {
        }
        	...
        	: base(false, tryCreateFormsObject)
        {
            ...
            {
                Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "Elements/DividerHorizontal");
        ...
        {
            AccentLeft = this.GetGraphicalUiElementByName("AccentLeft") as global::TestProject.GumRuntimes.SpriteRuntime;
