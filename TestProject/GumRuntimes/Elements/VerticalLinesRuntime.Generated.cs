...
{
    public partial class VerticalLinesRuntime : global::TestProject.GumRuntimes.ContainerRuntime
    {
        #region State Enums
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    LinesSpriteTextureTopFirstValue = 960;
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    LinesSpriteTextureTopSecondValue = 960;
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Elements.VerticalLinesRuntime.VariableState fromState,global::TestProject.GumRuntimes.Elements.VerticalLinesRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state) 
        {
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    {
                        SetsValue = true,
                        Name = "LinesSprite.TextureAddress",
                        Type = "TextureAddress",
                    ...
                    {
                        SetsValue = true,
                        Name = "LinesSprite.TextureHeight",
                        Type = "int",
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                    {
                        ...
                        Name = "LinesSprite.TextureTop",
                        Type = "int",
                        Value = LinesSprite.TextureTop + 960
                    }
                    );
                    newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                    {
        ...
        public global::TestProject.GumRuntimes.SpriteRuntime LinesSprite { get; set; }
        	...
        	: base(false, tryCreateFormsObject)
        {
            ...
            {
                Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "Elements/VerticalLines");
        ...
        {
            LinesSprite = this.GetGraphicalUiElementByName("LinesSprite") as global::TestProject.GumRuntimes.SpriteRuntime;
        }
