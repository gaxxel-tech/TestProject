...
{
    public partial class SliderRuntime : global::TestProject.GumRuntimes.ContainerRuntime, global::TestProject.GumRuntimes.ISliderBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        TrackInstance.HeightUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                        TrackInstance.Width = -32f;
                        TrackInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentSliderCategoryState)
                    {
                        case  SliderCategory.Enabled:
                            ThumbInstance.CurrentButtonCategoryState = global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
                            FocusedIndicator.Visible = false;
                            break;
                        ...
                        case  SliderCategory.Highlighted:
                            ThumbInstance.CurrentButtonCategoryState = global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Highlighted;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.TrackInstance.HeightUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    setTrackInstanceWidthFirstValue = true;
                    TrackInstanceWidthFirstValue = -32f;
                    if (interpolationValue < 1)
                    {
                        this.TrackInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    if (interpolationValue < 1)
                    {
        ...
        public void InterpolateBetween (SliderCategory firstState, SliderCategory secondState, float interpolationValue) 
        {
            ...
            global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory ThumbInstanceCurrentButtonCategoryStateFirstValue= global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
            global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory ThumbInstanceCurrentButtonCategoryStateSecondValue= global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
            switch(firstState)
            {
                case  SliderCategory.Enabled:
                    if (interpolationValue < 1)
                    ...
                    ThumbInstanceCurrentButtonCategoryStateFirstValue = global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
                    break;
                case  SliderCategory.Focused:
                    if (interpolationValue < 1)
                    {
                ...
                case  SliderCategory.Highlighted:
                    ...
                    setThumbInstanceCurrentButtonCategoryStateFirstValue = true;
                    ThumbInstanceCurrentButtonCategoryStateFirstValue = global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Highlighted;
                    break;
                case  SliderCategory.HighlightedFocused:
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                case  SliderCategory.Enabled:
                    ...
                    ThumbInstanceCurrentButtonCategoryStateSecondValue = global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Enabled;
                    break;
                case  SliderCategory.Focused:
                    if (interpolationValue >= 1)
                    {
                ...
                case  SliderCategory.Highlighted:
                    ...
                    setThumbInstanceCurrentButtonCategoryStateSecondValue = true;
                    ThumbInstanceCurrentButtonCategoryStateSecondValue = global::TestProject.GumRuntimes.Controls.ButtonStandardRuntime.ButtonCategory.Highlighted;
                    break;
                case  SliderCategory.HighlightedFocused:
                    if (interpolationValue >= 1)
                    {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.SliderRuntime.VariableState fromState,global::TestProject.GumRuntimes.Controls.SliderRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.SliderRuntime.SliderCategory fromState,global::TestProject.GumRuntimes.Controls.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state) 
        {
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    {
                        SetsValue = true,
                        Name = "TrackInstance.HeightUnits",
                    ...
                    {
                        SetsValue = true,
                        Name = "NineSliceInstance.HeightUnits",
                        Type = "DimensionUnitType",
        ...
        global::TestProject.GumRuntimes.ISliderBehavior.SliderCategory global::TestProject.GumRuntimes.ISliderBehavior.CurrentSliderCategoryState
        {
            set
            {
                switch(value)
                {
                    case  global::TestProject.GumRuntimes.ISliderBehavior.SliderCategory.Enabled:
                        this.CurrentSliderCategoryState = SliderCategory.Enabled;
                        break;
                    case  global::TestProject.GumRuntimes.ISliderBehavior.SliderCategory.Focused:
                        this.CurrentSliderCategoryState = SliderCategory.Focused;
                        break;
                    case  global::TestProject.GumRuntimes.ISliderBehavior.SliderCategory.Highlighted:
                        this.CurrentSliderCategoryState = SliderCategory.Highlighted;
                        break;
                    case  global::TestProject.GumRuntimes.ISliderBehavior.SliderCategory.HighlightedFocused:
        ...
        public global::TestProject.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
        ...
        {
            TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as global::TestProject.GumRuntimes.ContainerRuntime;
