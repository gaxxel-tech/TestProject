...
{
    public partial class ButtonIconRuntime : global::TestProject.GumRuntimes.ContainerRuntime, global::TestProject.GumRuntimes.IButtonBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Icon.Height = 0f;
                        Icon.HeightUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                        Icon.Width = 0f;
                        Icon.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.HeightUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    setIconWidthFirstValue = true;
                    IconWidthFirstValue = 0f;
                    if (interpolationValue < 1)
                    {
                        this.Icon.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    if (interpolationValue < 1)
                    {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ButtonIconRuntime.VariableState fromState,global::TestProject.GumRuntimes.Controls.ButtonIconRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ButtonIconRuntime.ButtonCategory fromState,global::TestProject.GumRuntimes.Controls.ButtonIconRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
