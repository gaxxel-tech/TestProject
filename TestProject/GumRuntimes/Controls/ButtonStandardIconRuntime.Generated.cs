...
{
    public partial class ButtonStandardIconRuntime : global::TestProject.GumRuntimes.ContainerRuntime, global::TestProject.GumRuntimes.IButtonBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Icon.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentButtonCategoryState)
                    {
                        ...
                        case  ButtonCategory.Highlighted:
                            ...
                            TextInstance.CurrentColorCategoryState = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.White;
                            Icon.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                    }
        ...
        public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ButtonCategory.Highlighted:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.Icon.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.White;
                    break;
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ButtonStandardIconRuntime.VariableState fromState,global::TestProject.GumRuntimes.Controls.ButtonStandardIconRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ButtonStandardIconRuntime.ButtonCategory fromState,global::TestProject.GumRuntimes.Controls.ButtonStandardIconRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
