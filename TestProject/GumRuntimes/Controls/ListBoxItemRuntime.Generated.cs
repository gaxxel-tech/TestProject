...
{
    public partial class ListBoxItemRuntime : global::TestProject.GumRuntimes.ContainerRuntime, global::TestProject.GumRuntimes.IListBoxItemBehavior
    {
        #region State Enums
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentListBoxItemCategoryState)
                    {
                        ...
                        case  ListBoxItemCategory.Selected:
                            Background.CurrentColorCategoryState = global::TestProject.GumRuntimes.NineSliceRuntime.ColorCategory.Accent;
                            Background.Visible = true;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (ListBoxItemCategory firstState, ListBoxItemCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ListBoxItemCategory.Selected:
                    setBackgroundCurrentColorCategoryStateFirstValue = true;
                    BackgroundCurrentColorCategoryStateFirstValue = global::TestProject.GumRuntimes.NineSliceRuntime.ColorCategory.Accent;
                    if (interpolationValue < 1)
                    {
                        this.Background.Visible = true;
                    }
            ...
            switch(secondState)
            {
                ...
                case  ListBoxItemCategory.Selected:
                    setBackgroundCurrentColorCategoryStateSecondValue = true;
                    BackgroundCurrentColorCategoryStateSecondValue = global::TestProject.GumRuntimes.NineSliceRuntime.ColorCategory.Accent;
                    if (interpolationValue >= 1)
                    {
                        this.Background.Visible = true;
                    }
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ListBoxItemRuntime.VariableState fromState,global::TestProject.GumRuntimes.Controls.ListBoxItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ListBoxItemRuntime.ListBoxItemCategory fromState,global::TestProject.GumRuntimes.Controls.ListBoxItemRuntime.ListBoxItemCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        global::TestProject.GumRuntimes.IListBoxItemBehavior.ListBoxItemCategory global::TestProject.GumRuntimes.IListBoxItemBehavior.CurrentListBoxItemCategoryState
        {
            set
            {
                switch(value)
                {
                    case  global::TestProject.GumRuntimes.IListBoxItemBehavior.ListBoxItemCategory.Enabled:
                        this.CurrentListBoxItemCategoryState = ListBoxItemCategory.Enabled;
                        break;
                    case  global::TestProject.GumRuntimes.IListBoxItemBehavior.ListBoxItemCategory.Highlighted:
                        this.CurrentListBoxItemCategoryState = ListBoxItemCategory.Highlighted;
                        break;
                    case  global::TestProject.GumRuntimes.IListBoxItemBehavior.ListBoxItemCategory.Selected:
                        this.CurrentListBoxItemCategoryState = ListBoxItemCategory.Selected;
                        break;
                    case  global::TestProject.GumRuntimes.IListBoxItemBehavior.ListBoxItemCategory.Focused:
