...
{
    public partial class ComboBoxRuntime : global::TestProject.GumRuntimes.ContainerRuntime, global::TestProject.GumRuntimes.IComboBoxBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        Background.CurrentStyleCategoryState = global::TestProject.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                        ...
                        IconInstance.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                        ...
                        ListBoxInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                ...
                if (value != null)
                {
                    ...
                    switch(mCurrentComboBoxCategoryState)
                    {
                        ...
                        case  ComboBoxCategory.Highlighted:
                            TextInstance.CurrentColorCategoryState = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                            IconInstance.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryLight;
                            FocusedIndicator.Visible = false;
                            break;
                        case  ComboBoxCategory.Pushed:
                            TextInstance.CurrentColorCategoryState = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                            IconInstance.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                            FocusedIndicator.Visible = false;
                            break;
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateFirstValue = global::TestProject.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.Primary;
                    }
                    ...
                    if (interpolationValue < 1)
                    {
                        this.ListBoxInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    BackgroundCurrentStyleCategoryStateSecondValue = global::TestProject.GumRuntimes.NineSliceRuntime.StyleCategory.Solid;
        ...
        public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                ...
                case  ComboBoxCategory.Highlighted:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryLight;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                    break;
                case  ComboBoxCategory.Pushed:
                    if (interpolationValue < 1)
                    {
                    ...
                    if (interpolationValue < 1)
                    {
                        this.IconInstance.IconColor = global::TestProject.GumRuntimes.SpriteRuntime.ColorCategory.PrimaryDark;
                    }
                    setTextInstanceCurrentColorCategoryStateFirstValue = true;
                    TextInstanceCurrentColorCategoryStateFirstValue = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                    break;
                case  ComboBoxCategory.HighlightedFocused:
                    if (interpolationValue < 1)
                    {
            ...
            switch(secondState)
            {
                ...
                case  ComboBoxCategory.Highlighted:
                    ...
                    setTextInstanceCurrentColorCategoryStateSecondValue = true;
                    TextInstanceCurrentColorCategoryStateSecondValue = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.PrimaryLight;
                    break;
                case  ComboBoxCategory.Pushed:
                    if (interpolationValue >= 1)
                    {
                    ...
                    setTextInstanceCurrentColorCategoryStateSecondValue = true;
                    TextInstanceCurrentColorCategoryStateSecondValue = global::TestProject.GumRuntimes.TextRuntime.ColorCategory.PrimaryDark;
                    break;
                case  ComboBoxCategory.HighlightedFocused:
                    if (interpolationValue >= 1)
                    {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ComboBoxRuntime.VariableState fromState,global::TestProject.GumRuntimes.Controls.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.ComboBoxRuntime.ComboBoxCategory fromState,global::TestProject.GumRuntimes.Controls.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state) 
        {
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    {
                        SetsValue = true,
                        Name = "ListBoxInstance.WidthUnits",
                        Type = "DimensionUnitType",
        ...
        global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory global::TestProject.GumRuntimes.IComboBoxBehavior.CurrentComboBoxCategoryState
        {
            set
            {
                switch(value)
                {
                    case  global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Enabled:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Enabled;
                        break;
                    case  global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Disabled:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Disabled;
                        break;
                    case  global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Highlighted:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Highlighted;
                        break;
                    case  global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Pushed:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Pushed;
                        break;
                    case  global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.HighlightedFocused:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.HighlightedFocused;
                        break;
                    case  global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.Focused:
                        this.CurrentComboBoxCategoryState = ComboBoxCategory.Focused;
                        break;
                    case  global::TestProject.GumRuntimes.IComboBoxBehavior.ComboBoxCategory.DisabledFocused:
        ...
        public global::TestProject.GumRuntimes.Controls.ListBoxRuntime ListBoxInstance { get; set; }
        ...
        private void AssignInternalReferences () 
        {
            ...
            ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as global::TestProject.GumRuntimes.Controls.ListBoxRuntime;
