...
{
    public partial class SettingsViewRuntime : global::TestProject.GumRuntimes.ContainerRuntime, global::TestProject.GumRuntimes.ISettingsViewBehavior
    {
        #region State Enums
            ...
            set
            {
                ...
                switch(mCurrentVariableState)
                {
                    case  VariableState.Default:
                        ...
                        FullscreenCheckboxInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                        FullscreenCheckboxInstance.Y = 0f;
                        MusicVolumeLabel.LabelText = "Music Volume";
                        MusicVolumeLabel.Width = 0f;
                        MusicVolumeLabel.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                        MusicVolumeLabel.Y = 12f;
                        MusicSliderInstance.Width = 0f;
                        MusicSliderInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                        SoundVolumeLabel.LabelText = "Sound Effect Volume";
                        SoundVolumeLabel.Width = 0f;
                        SoundVolumeLabel.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                        SoundVolumeLabel.Y = 12f;
                        SoundSliderInstance.Width = 0f;
                        SoundSliderInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                        break;
                }
            }
        }
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    if (interpolationValue < 1)
                    {
                        this.FullscreenCheckboxInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    ...
                    if (interpolationValue < 1)
                    {
                        this.MusicSliderInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    if (interpolationValue < 1)
                    {
                    ...
                    if (interpolationValue < 1)
                    {
                        this.MusicVolumeLabel.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    ...
                    if (interpolationValue < 1)
                    {
                        this.SoundSliderInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
                    if (interpolationValue < 1)
                    {
                    ...
                    if (interpolationValue < 1)
                    {
                        this.SoundVolumeLabel.WidthUnits = Gum.DataTypes.DimensionUnitType.RelativeToParent;
                    }
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.Controls.SettingsViewRuntime.VariableState fromState,global::TestProject.GumRuntimes.Controls.SettingsViewRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state) 
        {
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    {
                        SetsValue = true,
                        Name = "FullscreenCheckboxInstance.WidthUnits",
                        Type = "DimensionUnitType",
                    ...
                    {
                        SetsValue = true,
                        Name = "MusicVolumeLabel.WidthUnits",
                        Type = "DimensionUnitType",
                    ...
                    {
                        SetsValue = true,
                        Name = "MusicSliderInstance.WidthUnits",
                        Type = "DimensionUnitType",
                    ...
                    {
                        SetsValue = true,
                        Name = "SoundVolumeLabel.WidthUnits",
                        Type = "DimensionUnitType",
                    ...
                    {
                        SetsValue = true,
                        Name = "SoundSliderInstance.WidthUnits",
                        Type = "DimensionUnitType",
        ...
        public global::TestProject.GumRuntimes.Controls.CheckBoxRuntime FullscreenCheckboxInstance { get; set; }
        public global::TestProject.GumRuntimes.Elements.LabelRuntime MusicVolumeLabel { get; set; }
        public global::TestProject.GumRuntimes.Controls.SliderRuntime MusicSliderInstance { get; set; }
        public global::TestProject.GumRuntimes.Elements.LabelRuntime SoundVolumeLabel { get; set; }
        public global::TestProject.GumRuntimes.Controls.SliderRuntime SoundSliderInstance { get; set; }
        ...
        {
            FullscreenCheckboxInstance = this.GetGraphicalUiElementByName("FullscreenCheckboxInstance") as global::TestProject.GumRuntimes.Controls.CheckBoxRuntime;
            MusicVolumeLabel = this.GetGraphicalUiElementByName("MusicVolumeLabel") as global::TestProject.GumRuntimes.Elements.LabelRuntime;
            MusicSliderInstance = this.GetGraphicalUiElementByName("MusicSliderInstance") as global::TestProject.GumRuntimes.Controls.SliderRuntime;
            SoundVolumeLabel = this.GetGraphicalUiElementByName("SoundVolumeLabel") as global::TestProject.GumRuntimes.Elements.LabelRuntime;
            SoundSliderInstance = this.GetGraphicalUiElementByName("SoundSliderInstance") as global::TestProject.GumRuntimes.Controls.SliderRuntime;
