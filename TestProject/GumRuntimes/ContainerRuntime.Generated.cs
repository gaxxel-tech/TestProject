...
{
    public partial class ContainerRuntime : global::Gum.Wireframe.GraphicalUiElement
    {
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            bool setAutoGridHorizontalCellsFirstValue = false;
            bool setAutoGridHorizontalCellsSecondValue = false;
            int AutoGridHorizontalCellsFirstValue= 0;
            int AutoGridHorizontalCellsSecondValue= 0;
            bool setAutoGridVerticalCellsFirstValue = false;
            bool setAutoGridVerticalCellsSecondValue = false;
            int AutoGridVerticalCellsFirstValue= 0;
            int AutoGridVerticalCellsSecondValue= 0;
            ...
            switch(firstState)
            {
                case  VariableState.Default:
                    ...
                    AlphaFirstValue = 255;
                    setAutoGridHorizontalCellsFirstValue = true;
                    AutoGridHorizontalCellsFirstValue = 4;
                    setAutoGridVerticalCellsFirstValue = true;
                    AutoGridVerticalCellsFirstValue = 4;
            ...
            switch(secondState)
            {
                case  VariableState.Default:
                    ...
                    setAutoGridHorizontalCellsSecondValue = true;
                    AutoGridHorizontalCellsSecondValue = 4;
                    setAutoGridVerticalCellsSecondValue = true;
                    AutoGridVerticalCellsSecondValue = 4;
                    if (interpolationValue >= 1)
                    {
                        this.Blend = Gum.RenderingLibrary.Blend.Normal;
                    }
            ...
            if (setAutoGridHorizontalCellsFirstValue && setAutoGridHorizontalCellsSecondValue)
            {
                AutoGridHorizontalCells = FlatRedBall.Math.MathFunctions.RoundToInt(AutoGridHorizontalCellsFirstValue* (1 - interpolationValue) + AutoGridHorizontalCellsSecondValue * interpolationValue);
            }
            if (setAutoGridVerticalCellsFirstValue && setAutoGridVerticalCellsSecondValue)
            {
                AutoGridVerticalCells = FlatRedBall.Math.MathFunctions.RoundToInt(AutoGridVerticalCellsFirstValue* (1 - interpolationValue) + AutoGridVerticalCellsSecondValue * interpolationValue);
            }
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (global::TestProject.GumRuntimes.ContainerRuntime.VariableState fromState,global::TestProject.GumRuntimes.ContainerRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        private Gum.DataTypes.Variables.StateSave GetCurrentValuesOnState (VariableState state) 
        {
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    {
                        SetsValue = true,
                        Name = "AutoGridHorizontalCells",
                        Type = "int",
                        Value = AutoGridHorizontalCells
                    }
                    );
                    newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                    {
                        SetsValue = true,
                        Name = "AutoGridVerticalCells",
                        Type = "int",
                        Value = AutoGridVerticalCells
                    }
                    );
                    newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                    {
            ...
            switch(state)
            {
                case  VariableState.Default:
                    ...
                    newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                    {
                        ...
                        Name = "AutoGridHorizontalCells",
                        Type = "int",
                        Value = AutoGridHorizontalCells + 4
                    }
                    );
                    newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                    {
        ...
        {
            get => mContainedObjectAsIpso?.Alpha ?? 255;
            set { if (mContainedObjectAsIpso is global::RenderingLibrary.Graphics.InvisibleRenderable invisibleRenderable) invisibleRenderable.Alpha = value; }
        }
        public new bool IsRenderTarget
        {
            get => mContainedObjectAsIpso?.IsRenderTarget ?? false;
            set { if (mContainedObjectAsIpso is global::RenderingLibrary.Graphics.InvisibleRenderable invisibleRenderable) invisibleRenderable.IsRenderTarget = value; }
        }
        public global::Gum.RenderingLibrary.Blend Blend
        {
