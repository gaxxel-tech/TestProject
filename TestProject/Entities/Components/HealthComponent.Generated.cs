...
{
    public partial class HealthComponent : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Entities.IEntity
    {
        ...
        public string EditModeType { get; set; } = "TestProject.Entities.Components.HealthComponent";
        protected FlatRedBall.Graphics.Layer LayerProvidedByContainer = null;
        public HealthComponent () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public HealthComponent (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public HealthComponent (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            {
                throw new System.Exception( "HealthComponent has been loaded with a Global content manager, then loaded with a non-global.  This can lead to a lot of bugs");
            }
            #endif
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("HealthComponentStaticUnload", UnloadStaticContent);
