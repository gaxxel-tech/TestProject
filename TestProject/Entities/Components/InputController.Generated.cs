...
{
    public partial class InputController : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Entities.IEntity
    {
        ...
        public string EditModeType { get; set; } = "TestProject.Entities.Components.InputController";
        protected FlatRedBall.Graphics.Layer LayerProvidedByContainer = null;
        public InputController () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public InputController (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public InputController (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            {
                throw new System.Exception( "InputController has been loaded with a Global content manager, then loaded with a non-global.  This can lead to a lot of bugs");
            }
            #endif
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("InputControllerStaticUnload", UnloadStaticContent);
