...
{
    public partial class StatsComponent : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Entities.IEntity
    {
        ...
        public string EditModeType { get; set; } = "TestProject.Entities.Components.StatsComponent";
        protected FlatRedBall.Graphics.Layer LayerProvidedByContainer = null;
        public StatsComponent () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public StatsComponent (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public StatsComponent (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            {
                throw new System.Exception( "StatsComponent has been loaded with a Global content manager, then loaded with a non-global.  This can lead to a lot of bugs");
            }
            #endif
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("StatsComponentStaticUnload", UnloadStaticContent);
