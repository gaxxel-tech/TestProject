...
{
    public partial class MovementController : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Entities.IEntity
    {
        ...
        private float mCurrentSpeed = 10f;
        /// <summary>
        /// CurrentStatsFromTheEntity
        /// </summary>
        ...
        public string EditModeType { get; set; } = "TestProject.Entities.Components.MovementController";
        protected FlatRedBall.Graphics.Layer LayerProvidedByContainer = null;
        public MovementController () 
        	: this(FlatRedBall.Screens.ScreenManager.CurrentScreen.ContentManagerName, true)
        {
        }
        public MovementController (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public MovementController (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            {
                throw new System.Exception( "MovementController has been loaded with a Global content manager, then loaded with a non-global.  This can lead to a lot of bugs");
            }
            #endif
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("MovementControllerStaticUnload", UnloadStaticContent);
